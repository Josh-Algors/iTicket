...
$rs=mysqli_query($conn,"select * from admin WHERE `email`='$email' or `username`='$username'");
...
else
{
      ...
      $query="INSERT INTO `admins`(`username`,`email`,`password`) VALUES('$username', '$email', '$pwd_hashed')";
