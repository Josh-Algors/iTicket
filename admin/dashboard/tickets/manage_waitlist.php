                ...
                <form action="" id="UserLoginNowForm" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group required">
                        <table>
                            ...
                            <tbody>
                                <?php
                                $user_ticket = mysqli_query($conn,"select * from waitlist_logs where payment_status=0 and approved=0 ORDER BY id ASC");
                                ...
                                if (mysqli_num_rows($user_ticket) > 0)
                                {
                                    ...
                                    while ($row = mysqli_fetch_assoc($user_ticket)) 
                                    {
                                        ...
                                        $id = $row['id'];
                                        echo "<td><button onclick=goToAnotherPage() id='approve' value='$id' name='approve'>Approve</button></td>";
